...
public class Matchers extends Registry<String, Matcher, Register> {
    ...
    private Matchers() {
        ...
        install(CompositeMatchers.ClassicGumtreeSubtree.class);
        install(CompositeMatchers.SimpleGumtree.class);
        install(CompositeMatchers.SimpleIdGumtree.class);
        install(CompositeMatchers.SimpleIdGumtree2.class);
        install(CompositeMatchers.SimpleIdGumtree3.class);
        install(CompositeMatchers.SimpleIdGumtree4.class);
