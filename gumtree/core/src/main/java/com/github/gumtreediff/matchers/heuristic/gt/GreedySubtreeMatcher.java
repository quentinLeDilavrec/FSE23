...
public class GreedySubtreeMatcher extends AbstractSubtreeMatcher {
    ...
    public void filterMappings(MultiMappingStore multiMappings) {
        ...
        System.out.println("ambiguousList = "+ ambiguousList.size());
        MappingComparators.FullMappingComparator comp = new MappingComparators.FullMappingComparator(mappings);
        Collections.sort(ambiguousList, comp);
        System.out.println("comparisons = "+ comp.count + " "+ comp.count1 + " "+ comp.count2 + " "+ comp.count3 + " "+ comp.count4 + " ");

        // Select the best ambiguous mappings
        retainBestMapping(ambiguousList, srcIgnored, dstIgnored);
        // System.out.println("greedy subtree matcher mappings: "+mappings.size());
    }
