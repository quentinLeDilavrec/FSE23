...
public class MappingComparators {
    public static class FullMappingComparator implements Comparator<Mapping> {
        ...
        public int compare(Mapping m1, Mapping m2) {
            ...
            if (m1.first.getParent() == m2.first.getParent()
                ...
                // System.out.println("compare with siblings. "+m1+" "+m2);
                result = siblingsComparator.compare(m1, m2);
                if (result != 0)
                    return result;
    
                count2+=1;
                // System.out.println("compare with parents. "+m1+" "+m2);
            ...
            count3+=1;
            // System.out.println("compare with relative pos. "+m1+" "+m2);
            result = parentsPositionComparator.compare(m1, m2);
            if (result != 0)
                return result;

            count4+=1;
            // System.out.println("compare with absolute pos. "+m1+" "+m2);
    ...
    public static class SiblingsSimilarityMappingComparator implements Comparator<Mapping> {
        ...
        public int compare(Mapping m1, Mapping m2) {
            ...
            // System.out.println("sib="+cachedSimilarities.get(m2)+ ","+cachedSimilarities.get(m1));
