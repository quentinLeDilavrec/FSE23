...
public class TestActionIo {
    ...
    public void testBasicXmlActions() throws IOException {
        System.out.println(ActionsIoUtils.toXml(p.first, actions, ms, new ArrayList<>()));
    }

    @Test
    public void testBasicTextActions() throws IOException {
        System.out.println(ActionsIoUtils.toText(p.first, actions, ms, new ArrayList<>()));
    }

    @Test
    public void testBasicJsonActions() throws IOException {
        System.out.println(ActionsIoUtils.toJson(p.first, actions, ms, new ArrayList<>()));
    }
}
